...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\laravel\clinic-appointment-system\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\laravel\\clinic-appointment-system\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'hashing.rehash_on_login','view.paths','view.compiled','livewire.class_namespace','livewire.view_path',
...
'signed','throttle','verified','auth.admin',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file','login.page','login.user','admin.dashboard',
'admin.profile.update-profile','admin.profile.update-password','admin.profile.update-profile-picture','storage.local',);
        registerArgumentsSet('views', 
'Admin.Dashboard','Admin.SideAdmin','Links.links','Links.scripts','Pages.Main',
'auth.login','components.headers.form-header','components.includes.sessions','contents.dashboard.cards','contents.dashboard.index',
'contents.user-toggle.index','contents.user-toggle.update-password','contents.user-toggle.update-profile','contents.user-toggle.update-profile-picture','includes.navbar',
'layouts.app','livewire.user-profile.section-header','livewire.user-profile.update-profile-information','livewire.user-profile.update-user-password','livewire.user-profile.update-user-profile-image',
